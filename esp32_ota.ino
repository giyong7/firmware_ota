...
/* ============ OTA FILE URL ============ */
const char *firmwareURL ="https://drive.google.com/uc?export=download&id=1ChXUq8ImvtqXHhC0pZf6PYEL6H4VKC29";// "http://192.168.0.65/it/firmware_ota/esp32_ota.bin"; // ganti sesuai server
void Logo_OTA()
{
...
void otaUpdate()
{
    ...
    client.setInsecure(); // Google Drive pakai HTTPS

    HTTPClient http;
http.setFollowRedirects(HTTPC_STRICT_FOLLOW_REDIRECTS);

    Serial.println("⬇️ Download firmware (Google Drive)...");
    ...
    Serial.println("📦 Firmware size: UNKNOWN (chunked)");
